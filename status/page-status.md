...
Google Search Console ownership was verified by DNS on 2026-09-04. Google discovered the 5 URLs in the first sitemap submission. The current sitemap contains 6 URLs after publication of P003 and is awaiting Google's next read. Indexing and performance reports are still processing; see [`search-console.md`](search-console.md).
...
| P003 | 100g Protein Indian Diet: A Repeatable Vegetarian and Eggetarian Plan | [Live page](https://strongonrepeat.com/100g-protein-indian-diet/) | Published | India + Indian women in US | C01 · 100g protein per day; C03 · vegetarian meal plan; C04 · eggetarian | 100g protein diet | 480 | 540 | 27 | Intent checked; full top-result review pending | Pending | — | — | — | — | — |
...
| P012 | 100g Protein Indian Vegetarian Meal Plan for Women | `/100g-protein-indian-vegetarian-meal-plan-for-women/` | Consolidated into P003 | India + Indian women in US | C01; C03; C04 | 100g protein Indian vegetarian diet | — | C01: 540; C03: 210 | C01: 27; C03: 32 | Same intent is covered by P003 | Low |
